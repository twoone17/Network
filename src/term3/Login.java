...
public class Login extends JPanel{
   ...
   {   
      ...
      la1.setBounds(200, 200, 80, 30);
      tf=new JTextField();
      tf.setBounds(285, 200, 150, 30);
      add(la1); add(tf);
      
      //로그인 부분 비밀번호와 비밀번호 칠 textField
      la2=new JLabel("대화명",JLabel.RIGHT);
      la2.setBounds(200, 235, 80, 30);
      pf=new JTextField();
      pf.setBounds(285, 235, 150, 30);
      add(la2); add(pf);
      ...
      la3.setBounds(200, 300, 80, 30);
      rb1.setBounds(285, 300, 70, 30);
      rb2.setBounds(400, 300, 70, 30);
      rb1.setOpaque(false);
      rb2.setOpaque(false);
